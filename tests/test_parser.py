...
def test_gvh5075_debug_hex(caplog):
    ...
    assert (
        "Parsing Gmopeka_iot sensor: 60552 b'\\x00\\x03\\x41\\xc2\\x64\\x00\\x4c\\x00\\x02\\x15\\x49\\x4e\\x54"
